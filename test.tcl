proc getPresetInfo {} {
  return [dict create name {test} description {test}  vlnv xilinx.com:ip:processing_system7:5.5 display_name {test} ]
}
...
proc apply_preset {IPINST} {
  return [dict create \
    ...
    CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {22.727272}  \
    ...
    CONFIG.PCW_ACT_FPGA0_PERIPHERAL_FREQMHZ {22.727272}  \
