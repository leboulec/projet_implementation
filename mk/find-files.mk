...
#XSIM_ELAB_LIBRARIES = -L xpm -L unisims_ver -L unimacro_ver -L secureip -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_5 -L processing_system7_vip_v1_0_7 -L xil_defaultlib -L xilinx_vip
#XSIM_ELAB_FLAGS     = --incr --relax --debug typical
#XSIM_VLOG_OPT       = --incr ${XSIM_VLOG_INCLUDE} --work xil_defaultlib ${XSIM_ELAB_LIBRARIES}
#XSIM_VHDL_OPT       = --incr --work xil_defaultlib ${XSIM_ELAB_LIBRARIES}
